...
public class CommentApiController {
    ...
    //R 조회
    @GetMapping("/api/movies/1/{movieId}/comments")  //쥬라기 월드
    ...
    @GetMapping("/api/movies/2/{movieId}/comments")  //F1
    ...
    @GetMapping("/api/movies/3/{movieId}/comments")  //드래곤 길들이기
    ...
    //U 수정
    @PatchMapping("/api/comments/1/{id}")
    ...
    @PatchMapping("/api/comments/2/{id}")
    ...
    @PatchMapping("/api/comments/3/{id}")
    ...
    //D 삭제
    @DeleteMapping("/api/comments/1/{id}")
    ...
    @DeleteMapping("/api/comments/2/{id}")
    ...
    @DeleteMapping("/api/comments/3/{id}")
